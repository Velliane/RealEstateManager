...
fun updatePropertyInformation(id_property: String, type: String, price: Int, surface: Int, rooms_nbr: Int, bath_nbr: Int, bed_nbr: Int, description: String, in_sale: Boolean, address: String): Task<Void>{
    return getPropertiesCollection().document(id_property).update("type", type, "price", price, "surface", surface, "rooms_nbr", rooms_nbr, "bath_nbr", bath_nbr, "bed_nbr", bed_nbr, "description", description, "in_sale", in_sale, "address", address)
}