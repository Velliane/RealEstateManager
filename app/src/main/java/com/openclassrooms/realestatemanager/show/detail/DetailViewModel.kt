...
class DetailViewModel(private val propertyDataRepository: PropertyDataRepository, private val geocodeRepository: GeocodeRepository, private val addressDataRepository: AddressDataRepository, private val photoDataRepository: PhotoDataRepository): ViewModel() {
