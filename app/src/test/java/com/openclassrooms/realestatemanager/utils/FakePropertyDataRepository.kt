...
class FakePropertyDataRepository(private val propertyDao: PropertyDao): PropertyDataRepository(propertyDao) {
    ...
    override fun getAllProperties(): LiveData<List<Property>> {
        ...
        val property1 = Property("001", "025","House", 0,250500, 125, 4, 2, 2, "Big house", true, "2020-03-12T12:20:25")
    ...
    override suspend fun getPropertyFromId(id_property: String): Property {
        ...
        if(id_property == "001"){
            property = Property("001", "025","House", 0,250500, 125, 4, 2, 2, "Big house", true, "2020-03-12T12:20:25")
        }else if(id_property == "002"){
            property = Property("002", "025","House", 0,185000, 75, 3, 1, 2, "Little house", true, "2020-03-09T12:20:25")
        }
        return property
    }
